...
# ╔═╡ 1fa44ad2-edd4-11ec-3149-f98cd40147ad
begin
	using Downloads
using CitableBase
...
function load_data()
    ...
    lsj_path = joinpath("dashboard","assets", "lexicon.cex")
...
# ╔═╡ 2145fdad-4b97-43ff-862a-d0329e56e256
println("example: $(lsj_keys[200]): $(typeof(lsj_keys[200]))")


# ╔═╡ f6df4dba-673b-4ea9-85fd-b1e6c4046c8d
...
BetaReader = "~0.2.0"
CitableBase = "~10.2.1"
CitableCollection = "~0.4.3"
CitableObject = "~0.15.0"
Tables = "~1.7.0"
"""
...
[[deps.BetaReader]]
deps = ["Compat", "Dash", "DocStringExtensions", "Documenter", "Flux", "IterTools", "PolytonicGreek", "Test", "TestSetExtensions", "Unicode"]
git-tree-sha1 = "17c4f7d5769ecc1582fae41226b0fefe658ba148"
...
git-tree-sha1 = "b3d0cec405194c0a0e05c515c5eababdf66e28ee"
